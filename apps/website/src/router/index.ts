...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/guides/freelance-2026', name: 'guide-freelance-2026', component: () => import('../views/guides/Freelance2026GuideView.vue'), meta: { title: 'Freelance 2026 : Guide complet | Altruisme.DEV', description: 'Le guide complet 2026 pour construire, développer et pérenniser une activité freelance.' } },
    { path: '/guides/saas-2026', name: 'guide-saas-2026', component: () => import('../views/guides/Saas2026GuideView.vue'), meta: { title: 'SaaS 2026 : Guide complet | Altruisme.DEV', description: 'Le guide complet 2026 pour comprendre, construire, lancer et développer un produit SaaS.' } },
