...
onBeforeUnmount(() => window.removeEventListener(OPEN_COOKIE_SETTINGS_EVENT, openSettings))
</script>
      ...
      <div v-if="!showSettings" class="grid gap-6 sm:grid-cols-[1fr_auto] sm:items-end">
        <div>
          ...
          <p class="mt-2 max-w-xl text-sm leading-6 text-[#46504d]">
            Cloud ne charge aucun contenu externe sans ton accord. Les éléments nécessaires au bon
        ...
        >
          <span
            ...
            ><span class="mt-1 block text-sm leading-6 text-[#46504d]"
              >Autorise les services tiers qui pourraient être ajoutés à Cloud.</span
            ></span
          >
